...
class CHideItem;
class CAutoHideBar;
class AFX_EXT_CLASS CDockPageBar : public baseCDockPageBar
{
...
public:
	...
	int				m_nActivePage;
	BOOL			m_isActive;
	CHideItem*		m_pHideItem;
	CAutoHideBar*	m_pAutoHideBar;
...
// Construction
	...
	void FreeAll();
	BOOL GetDockBarZOrderList(HWND hParent,int zOrderList[4]);
// Drag Operations
