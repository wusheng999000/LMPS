...
class CHideItem;
class CHidePageItem;
class AFX_EXT_CLASS CAHFloatWnd : public CWnd
{
// Construction
public:
	CAHFloatWnd();
...
class AFX_EXT_CLASS CAutoHideBar : public CControlBar
{
// Construction
public:
	CAutoHideBar();
...
// Implementation
public:
	void Dock( CString sTitle );			//20100913 Sail
	void RemoveItem( CString sTitle );		//20100913 Sail
	void UpdateBar();
...
class AFX_EXT_CLASS CAutoHideFrame : public CFrameWnd
{
...
class AFX_EXT_CLASS CMDIAutoHideFrame : public CMDIFrameWnd
{
